Welcome to Arcas' documentation!
=================================
...
Details on using each API, including guidelines for adding your key to the
right place can be found under the Guides.

Thank you for using the package, do not forget to open issues with requests and
